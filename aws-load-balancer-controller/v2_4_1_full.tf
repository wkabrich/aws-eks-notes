...
# Adapted for terraform from the example manifests found in the sig's installation guide
# https://kubernetes-sigs.github.io/aws-load-balancer-controller/v2.4/deploy/installation/
# raw https://github.com/kubernetes-sigs/aws-load-balancer-controller/releases/download/v2.4.1/v2_4_1_full.yaml
...
resource "kubernetes_manifest" "serviceaccount_kube_system_aws_load_balancer_controller" {
  manifest = {
    apiVersion = "v1"
    kind       = "ServiceAccount"
    metadata = {
...
resource "kubernetes_manifest" "role_kube_system_aws_load_balancer_controller_leader_election_role" {
  manifest = {
...
resource "kubernetes_manifest" "clusterrole_aws_load_balancer_controller_role" {
  manifest = {
    apiVersion = "rbac.authorization.k8s.io/v1"
    kind       = "ClusterRole"
    metadata = {
...
resource "kubernetes_manifest" "rolebinding_kube_system_aws_load_balancer_controller_leader_election_rolebinding" {
  manifest = {
    apiVersion = "rbac.authorization.k8s.io/v1"
    kind       = "RoleBinding"
    metadata = {
...
resource "kubernetes_manifest" "clusterrolebinding_aws_load_balancer_controller_rolebinding" {
  manifest = {
    apiVersion = "rbac.authorization.k8s.io/v1"
...
resource "kubernetes_manifest" "service_kube_system_aws_load_balancer_webhook_service" {
  manifest = {
    apiVersion = "v1"
    kind       = "Service"
    metadata = {
...
resource "kubernetes_manifest" "deployment_kube_system_aws_load_balancer_controller" {
  manifest = {
    apiVersion = "apps/v1"
    kind       = "Deployment"
    metadata = {
